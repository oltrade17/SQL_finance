...
CREATE TABLE `good_types` (
  `good_type_id` int(11) NOT NULL AUTO_INCREMENT,
  `good_type_name` text NOT NULL,
...
INSERT INTO `good_types` VALUES (1,'product'),(2,'connection'),(3,'industrial'),(4,'transport'),(5,'chancellery');
